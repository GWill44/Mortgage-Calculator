...
public class PaymentSchedule {
    ...
    private static double calculateBalance(short numberOfPaymentsMade) {
        ...
        double balance =
                Console.getPrincipal() * ((Math.pow(1 + monthlyInterest, totalNumberOfPayments) - Math.pow(1 + monthlyInterest, numberOfPaymentsMade)) / (Math.pow(1 + monthlyInterest, totalNumberOfPayments) - 1));
        return balance;
    }
